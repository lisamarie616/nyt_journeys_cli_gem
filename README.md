...
You can install this gem via gem install nyt_journeys_cli_gem. The nyt_journeys CLI will be installed and you can run nyt_journeys to get a list of journeys available with NY Times.
